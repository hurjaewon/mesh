...
namespace ns3
{
      ...
      Time & delay)
  {
    ...
    //  { 497267, 991790, 1971039, 2950210, 3917726, 4927704, 5897102, 6863758, 7847969, 8817213, 9783619, 10748731, 11712402, 12675078, 13636242, 14596418};
    {500000,1000000,2000000,3000000,4000000,5000000,6000000,7000000,8000000,9000000,10000000,11000000,12000000,13000000,14000000,15000000};
