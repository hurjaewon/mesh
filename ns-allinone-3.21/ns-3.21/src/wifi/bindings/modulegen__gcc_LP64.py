...
def register_Ns3BlockAckManager_methods(root_module, cls):
    ...
    cls.add_method('NotifyGotBlockAck', 
                   'uint16_t', 
                   [param('ns3::CtrlBAckResponseHeader const *', 'blockAck'), param('ns3::Mac48Address', 'recipient'), param('uint16_t*', 'results'), param('uint16_t*', 'size')])
...
def register_Ns3WifiPhy_methods(root_module, cls):
    ...
    cls.add_method('SendPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'packet'), param('ns3::WifiTxVector', 'txvector'), param('ns3::WifiPreamble', 'preamble'), param('uint16_t', 'bw')], 
									 ##shbyeon
    ...
    cls.add_method('SetReceiveErrorCallback', 
                   ...
                   [param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, double, ns3::WifiMode, bool, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'callback')], 
                   is_pure_virtual=True, is_virtual=True)
...
def register_Ns3WifiPhyStateHelper_methods(root_module, cls):
    ...
    cls.add_method('SwitchFromRxEndError', 
                   ...
                   [param('ns3::Ptr< ns3::Packet const >', 'packet'), param('double', 'snr'), param('ns3::WifiMode','mode'), param('bool','rxOneMPDU')])
...
def register_Ns3YansWifiPhy_methods(root_module, cls):
    ...
    cls.add_method('StartReceivePacket', 
                   'void', 
									 [param('ns3::Ptr< ns3::Packet >', 'packet'), param('double', 'rxPowerDbm'), param('ns3::WifiTxVector', 'txVector'), param('ns3::WifiPreamble', 'preamble'), param('enum', 'ch')])
									 ##shbyeon
...
def register_Ns3MacLow_methods(root_module, cls):
    ...
    cls.add_method('ReceiveError', 
                   ...
                   [param('ns3::Ptr< ns3::Packet const >', 'packet'), param('double', 'rxSnr'), param('ns3::WifiMode', 'mode'), param('bool', 'rxOneMPDU')])
